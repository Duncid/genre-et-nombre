...
const categories: Category[] = [
  {
    ...
    modes: [
      { mode: "gender", title: "Féminin / Masculin", subtitle: "UN ou UNE ?", Icon: BookOpen, tone: TONES.gender },
      { mode: "number", title: "Singulier / Pluriel", subtitle: "Un ou plusieurs ?", Icon: Users, tone: TONES.number },
      { mode: "mix", title: "Mode Mixte", subtitle: "Genre + Nombre", Icon: Shuffle, tone: TONES.mix },
      { mode: "words", title: "Mode Mots", subtitle: "Mots écrits", Icon: Type, tone: TONES.words },
    ],
  },
  {
    id: "phrase",
    ...
    modes: [
      { mode: "adjectives", title: "Mots & Adjectifs", subtitle: "les grands arbres", Icon: PenLine, tone: TONES.adjectives },
      { mode: "adjective-choice", title: "Choisis l'adjectif", subtitle: "accord en genre/nombre", Icon: Sparkles, tone: TONES["adjective-choice"] },
      { mode: "sentence", title: "Structure de phrase", subtitle: "dét. / adj. / nom", Icon: Layers, tone: TONES.sentence },
      { mode: "sentence-advanced", title: "Structure avancée", subtitle: "verbe, pronom…", Icon: GraduationCap, tone: TONES["sentence-advanced"] },
    ],
  },
  {
    id: "maths",
    ...
    modes: [
      { mode: "multiplication", title: "Multiplications", subtitle: "tables de 2 à 5", Icon: X, tone: TONES.multiplication },
    ],
  },
];
